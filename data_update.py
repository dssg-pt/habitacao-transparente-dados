...
# load data
client = pymongo.MongoClient(f"mongodb+srv://{mongo_user}:{mongo_pass}@habitacao.y9hxkyt.mongodb.net/")
...
colsToKeep = ['situacao-habitacional', 'distrito', 'concelho',
        'area-util', 'tipo-casa', 'tipologia', 'ano_nascimento_interval',
       'nacionalidade_pt', 'rendimento-anual', 'num-pessoas-nao-dependentes',
...
# save data
df[colsToKeep].to_csv('dados.csv')
